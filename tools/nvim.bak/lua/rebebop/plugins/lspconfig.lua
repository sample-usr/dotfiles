...
local on_attach = function(client, bufnr)
	...
	keymap.set("n", "gt", "<cmd>Lspsaga peek_type_definition<CR>", opts) -- peak type definition
	...
	keymap.set("n", "<leader>ch", "<cmd>Lspsaga hover_doc<CR>", opts) -- show documentation for what is under cursor
